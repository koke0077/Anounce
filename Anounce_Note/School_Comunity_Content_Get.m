...
@interface School_Comunity_Content_Get ()
...
@implementation School_Comunity_Content_Get
...
-(void)connectionDidFinishLoading:(NSURLConnection *)connection{
    ...
    [self.delegate compliteGetComunityTitle:title Contents:content Files:files_arr];
