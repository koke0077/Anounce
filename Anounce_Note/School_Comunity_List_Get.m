...
@interface School_Comunity_List_Get(){
...
@implementation School_Comunity_List_Get
...
-(void)connectionDidFinishLoading:(NSURLConnection *)connection{
    ...
    [self.delegate compliteToGetComunityList:title_arr News_Url:url_arr];
    
}

-(void)connection:(NSURLConnection *)connection didFailWithError:(NSError *)error{
 
    [self.delegate failedToGetComunityList];
}
