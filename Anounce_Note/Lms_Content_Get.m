...
@implementation Lms_Content_Get
...
-(NSString *)devideString:(NSString *)HTML{
    ...
    NSString *startTag = @"colspan=\"6\"";
    NSString *secondTag = @"Cont";
    NSString *endTag = @"</td>";
...
-(void)connectionDidFinishLoading:(NSURLConnection *)connection{
    ...
    [self.delegate compliteGetContents:[self stripTags:str]];
