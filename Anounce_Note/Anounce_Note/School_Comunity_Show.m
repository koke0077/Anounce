...
@interface School_Comunity_Show (){
...
@implementation School_Comunity_Show
@synthesize myTitle, myContents_url, str_title, school_url;
...
- (void)viewDidLoad {
    ...
    School_Comunity_Content_Get *news_get = [[School_Comunity_Content_Get alloc]init];
    news_get.delegate = self;
    [news_get parsingWithComunityUrl:myContents_url];
