...
- (NSString *)getDBPath {
    ...
    return [documentsDir stringByAppendingPathComponent:@"school_data8.sqlite"];
}
...
-(void)initDB{
    ...
    if(!success) {
        ...
        NSString *defaultDBPath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"school_data8.sqlite"];
