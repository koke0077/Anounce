...
- (NSString *)getDBPath {
    ...
    return [documentsDir stringByAppendingPathComponent:@"school_data9.sqlite"];
}
...
-(void)initDB{
    ...
    if(!success) {
        ...
        NSString *defaultDBPath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"school_data9.sqlite"];
