...
@interface Add_Student_Name : UIViewController<UITextFieldDelegate, Class_Delegate, Pass_lms_Delegate, Class_Make_Delegate, Board_1_delegate, Board_2_delegate, SendNewsDelegate>
